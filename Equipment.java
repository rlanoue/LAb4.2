...
public class Equipment
{
    ...
    {
        return String.format("Name: %s, Number: %d, Weight: %.1flbs, Price: $%.2f - %s",
                name, count, totalWeight, totalPrice, description);
    }
    ...
    public boolean equals(Object other)
    {
        ...
        equals = equals && this.name.equals(otherEq.getName()); 
        equals = equals && this.count == otherEq.getCount();
        equals = equals && this.getTotalWeight() == otherEq.getTotalWeight(); 
        equals = equals && this.getTotalPrice() == otherEq.getTotalPrice(); 
        equals = equals && this.description.contentEquals(otherEq.getDescription()); 
        // TODO: finish this...
